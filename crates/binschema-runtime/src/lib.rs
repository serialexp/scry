// @generated by binschema — DO NOT EDIT.
//
// Copied verbatim from the binschema repo (rust/src/) every time
// bindings are regenerated. Any edit made here — including a lint fix —
// is silently reverted by the next `binschema generate` run. Change the
// upstream file instead, then regenerate.
